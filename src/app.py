...
from forms import RegistrationForm, ResultsQueryForm, ConsentForm, LabQueryForm, LabCheckInForm, LabRackResultsForm, \
    LabProbeEditForm
    ...
    if request.method == 'POST':
        if 'search' in request.form:
            if form.validate_on_submit():
                ...
                return render_template('lab/probe_query.html', form=form, edit_form=edit_form, sample=sample,
                                       search=search)
