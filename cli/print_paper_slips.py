...
^CF0,30
^FO50,620^FD... oder scannen Sie diesen QR-Code:^FS
^FO50,660^FD... or scan this QR-Code:^FS

^BY5,4,270
^FT180,1040^BQN,2,7^FH\^FDHA,https://covidtest-hd.de/?code={{ access_code_url }}^FS


^FX Additional information line

^FO50,1100^FD Name:^FS
^FO50,1160^GB700,3,3^FS
^FO50,1220^FD Datum:^FS
^FO50,1280^GB700,3,3^FS

^FO50,1350^GFA,512,512,8,,:::::::::::L07FFE,L0JF8,K01JFC,K03JFE,K07KF,K0LF,007PFE,01RF8,:03RFC,03PFE1C,03JFE007FFE1C,03JFC003IF3C,03JF03C0JFC,03IFE0FF07IFC,03IFE3FFC7IFC,03IFC7FFE3IFC,03IF87FFE1IFC,03IF8JF1IFC,:03IF9JF9IFC,03IF1JF8IFC,:03IF9JF9IFC,03IF8JF1IFC,::03IFC7FFE3IFC,03IFC3FFC3IFC,03IFE1FF87IFC,03JF03C0JFC,03JF8001JFC,03JFE007JFC,03KFC3KFC,03RFC,:::01RF8,00RF,,:::::::::::^FS

^FO120,1372^FD Bitte Zettel fotografieren oder aufheben ^FS

^CF0,20
^FO50,1470^FDBC: {{ barcode }} BID: {{ bag_id }}^FS
